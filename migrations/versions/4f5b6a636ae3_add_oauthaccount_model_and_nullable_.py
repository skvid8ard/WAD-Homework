"""Add OAuthAccount model and nullable password

Revision ID: 4f5b6a636ae3
Revises: 
Create Date: 2026-04-25 04:37:30.086872
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('oauth_name', 'account_id', name='uq_oauth_account_id')
    )
