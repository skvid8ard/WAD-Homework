    ...
    <div className="flex min-h-screen items-center justify-center p-4 relative">
      ...
      >
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <button className="flex items-center justify-center gap-2 w-full px-4 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-800 text-gray-700 dark:text-gray-300 font-medium opacity-50 cursor-not-allowed transition-all duration-200 active:scale-[0.98]">
